...
#max_encoder_seq_length = max([len(input_doc) for input_doc in input_docs])
#max_decoder_seq_length = max([len(target_doc) for target_doc in target_docs])
